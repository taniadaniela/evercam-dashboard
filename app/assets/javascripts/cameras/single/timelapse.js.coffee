...
getTimelapseHtml = (timelapse, index) ->
  ...
  html += "                                             <source type='application/x-mpegURL' src='http://localhost:81/#{timelapse.camera_id}/timelapses/#{timelapse.id}/index.m3u8'></source>"
  html += "                                         </video>"
  html += '                                       </div>'
  ...
  html += '                                             <tr><td>HLS URL: </td><td class="hls-url-right" id="tdHlsUrl' + timelapse.id + '"><input id="txtHlsUrl' + timelapse.id + '" type="text" readonly class="txt-width" value="http://timelapse.evercam.io/timelapses/' + timelapse.camera_id + '/' + timelapse.id + '/timelapse.m3u8"/>'
