...
(function() {
  var addSharingCameraRow, initializeSharingTab, onAddSharingUserClicked, onDeleteShareClicked, onSetCameraAccessClicked, sendAJAXRequest, showError, showFeedback;
  ...
  addSharingCameraRow = function(details) {
    var cell, div, inner, option, row, select, span;
    row = $('<tr>');
    cell = $('<td>');
  ...
  onAddSharingUserClicked = function(event) {
    var data, emailAddress, onError, onSuccess, permissions, settings;
    event.preventDefault();
