...
(function() {
  var addSharingCameraRow, createShare, initializeSharingTab, onAddSharingUserClicked, onDeleteShareClicked, onDeleteShareRequestClicked, onPermissionsFocus, onSaveShareClicked, onSaveShareRequestClicked, onSetCameraAccessClicked, onSharingOptionsClicked, sendAJAXRequest, showError, showFeedback;
  ...
  addSharingCameraRow = function(details) {
    var button, cell, div, option, row, select, span, suffix;
    row = $('<tr>');
    ...
    button = $('<button>', {
      "class": "save show-save btn btn-primary bt-sm"
    });
    button.text("Save");
...
(function() {
  var initialize, onAddShareClicked, showError, showFeedback;
  ...
  onAddShareClicked = function(event) {
    var cameraID, emailAddress, link, onError, onSuccess, permissions;
    event.preventDefault();
    link = $(event.target);
