...
// Sub menus
var $displayingSubMenu, $freeDrawingSubMenu, $drawLineSubMenu, $drawShapeSubMenu, $textSubMenu, $iconSubMenu, $filterSubMenu, $imageFilterSubMenu, $cropSubMenu;
...
function load_image() {
  ...
  imageEditor.loadImageFromURL(url, image_title).then(function (sizeValue) {
    imageEditor.clearUndoStack();
  });
}
